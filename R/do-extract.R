                       ...
                       model = "lsd")
{
    ...
    do_extract <- c("lp__",
                    ...
                    "par_q_cpue_i", "par_q_puerulus_i", "par_q_cpue_drift_i", "par_init_erate_i", "par_move_i",
                    "Btot0_r", "Ntot0_r", "Btot_curr_jr", "Ntot_curr_jr",
                    "B0_r", "Bmin_jr", "Bcurr_jr", "Bproj_jr", "Bmsy_r", "B0now_r",
                    #"SSBref_jr", "Bref_jr", "n_SSBcurr_g_SSBref_r", "SSBref_SSB0_jr", "Bref_B0_jr", "n_Bcurr_g_Bref_r", "n_Bref_g_Bmsy_r",
                    "SSB0_r", "SSBmsy_r", "SSBcurr_jr", "SSBproj_jr", "SSB0now_r",
                    "MSY_r", "Fmult_r", "Fmsy_r", "Hcurr_r", "Hproj_r", "Rmean_r", "CPUEcurr_jr", "CPUEproj_jr",
                    "n_Bcurr_g_Bmin_r", "n_Bcurr_g_Bmsy_r", "n_SSBcurr_g_SSBmsy_r", "n_SSBcurr_l_20SSB0_r", "n_SSBcurr_l_10SSB0_r") # probablities
